...
public class UpdateSample {
    public UpdateSample(){
        ...
        //sql = UPDATE user_login SET user_name = 'ug', login_count = 3 WHERE id < 1250
        sql = "UPDATE user_login SET user_name = 'ug', login_count = 3 WHERE id < 1250";
        result = sqlService.update(sql);
        ...
        //sql = UPDATE user_login SET user_name = 'ug',login_count = 3 WHERE id = 1
        sql = "UPDATE user_login SET user_name = 'ug',login_count = 3 WHERE id = 1";
        result = sqlService.update(sql);
        System.out.println("4# result = " + result);

        //sql = UPDATE user_login SET login_count = 2, user_name = "u1" WHERE id = 2
        ...
        //sql = SELECT * FROM user_login WHERE id < 3
        sql = "SELECT * FROM user_login WHERE id < 3";
        result = sqlService.select(sql, UserLoginMap.class);
        if (result instanceof ArrayList) {
            list = (ArrayList<TableMap>)result;
